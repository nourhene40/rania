...
<!-- Mirrored from dsathemes.com/html/la_notte_1.1/files/demo-9.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 Jun 2023 07:28:15 GMT -->
<head>
	...
	<body>
			...
			<div class="blockChanger bgChanger">
                ...
                <div class="chBody white--color">	
					<div class="stBlock text-center" style="margin: 30px 20px 15px 26px">
						<p>Choose Layout</p>
						<a class="s_1" href="demo-1.html"><img src="images/color-scheme/l-01.jpg" width="180" height="195" alt="layout-image"></a>
		...
		<div id="page" class="page">
				 	...
				 	<!-- NAVIGATION MENU -->
				  	<div class="wsmainfull menu clearfix">
	    				<div class="wsmainwp clearfix">
	    					...
	    					<!-- HEADER LOGO -->
	    					<div class="desktoplogo"><a href="#hero-9" class="logo-black"><img src="images/logo-01.png" alt="header-logo"></a></div>
	    					<div class="desktoplogo"><a href="#hero-9" class="logo-white"><img src="images/logo-white.png" alt="header-logo"></a></div>
	        					...
	        					<ul class="wsmenu-list">
	        						...
	        						<!-- DROPDOWN MENU -->
						          	<li aria-haspopup="true"><a href="#">About <span class="wsarrow"></span></a>
	            						<ul class="sub-menu">
	            							<li aria-haspopup="true"><a href="#about-3a">About Studio</a></li>
	            							<li aria-haspopup="true"><a href="#promo-2">Our Promotions</a></li>
	            							<li aria-haspopup="true"><a href="#about-10">Best Experience</a></li>
	            							<li aria-haspopup="true"><a href="#reviews-1">Testimonials</a></li>	
	            							<li aria-haspopup="true"><a href="#gallery-4">Our Gallery</a></li>
						           		</ul>
								    </li>
							    	...
							    	<li class="nl-simple" aria-haspopup="true"><a href="#pricing-3">Menu</a></li>


							    	<li class="nl-simple" aria-haspopup="true"><a href="#gallery-2">Gallery</a></li>
								    ...
								    <li class="nl-simple" aria-haspopup="true">
								    	<a href="#footer-3" class="btn violet-red--btn tra-black--hover last-link">Contacts</a>
								    </li>  
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-8 col-lg-6">
							<div class="hero-9-txt">
								...
								<!-- Text -->
								<p class="p-title-md">Feugiat primis and ligula laoreet auctor undo mauris auctor laoreet purus pretium a 
								   sapien euismod
								</p>

								<!-- Button -->
								<a href="#about-4" class="btn violet-red--btn tra-black--hover">Find Out More</a>
			...
			<!-- ABOUT-3a
			============================================= -->
			<section id="about-3a" class="about-section division">
				<div class="container">
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-7 col-lg-6 order-first order-md-2">
							<div class="txt-block right-column wow fadeInLeft">
								...
								<!-- Section ID -->	
					 			...
					 			<!-- Title -->	
								<h3 class="h3-md">Choose the Glamour</h3>	
								...
								<div class="pricing-3-table pl-25 wow fadeInUp">
									...
									<ul class="pricing-3-list">
										...
										<li class="pricing-3-item">
											...
											<!-- Title & Price -->
											<div class="detail-price">
												<div class="price-name"><h5 class="h5-lg">Classic Pedicure</h5></div>
												<div class="price-dots"></div>
												<div class="price-number"><h5 class="h5-lg">$32</h5></div>
											</div>
										...
										<li class="pricing-3-item">
											...
											<div class="detail-price">
												...
												<div class="price-dots"></div>
												<div class="price-number"><h5 class="h5-lg">$37</h5></div>
											</div>

											<!-- Description -->
											<div class="price-txt">
												<p class="p-md"><em>Service length 50 minutes</em></p>
											</div>
										...
										<li class="pricing-3-item">
											...
											<!-- Title & Price -->
											<div class="detail-price">
												<div class="price-name"><h5 class="h5-lg">TC Signature Pedicure</h5></div>
												<div class="price-dots"></div>
												<div class="price-number"><h5 class="h5-lg">$44</h5></div>
											</div>
										...
										<li class="pricing-3-item">
											...
											<!-- Title & Price -->
											<div class="detail-price">
												<div class="price-name"><h5 class="h5-lg">Gel Pedicure</h5></div>
												<div class="price-dots"></div>
										...
										<li class="pricing-3-item resp-lst">
											...
											<!-- Title & Price -->
											<div class="detail-price">
												<div class="price-name"><h5 class="h5-lg">DeLuxe Gel Pedicure</h5></div>
												<div class="price-dots"></div>
												<div class="price-number"><h5 class="h5-lg">$84</h5></div>
											</div>

											<!-- Description -->
											<div class="price-txt">
												<p class="p-md"><em>Service length 60 minutes</em></p>
											</div>
					...
					<div class="row">
						...
						<div class="col-lg-8 offset-lg-2">
							<div class="banner-1-txt text-center white--color">
								...
								<!-- Button -->
								<a href="booking.html" class="btn btn-md violet-red--btn tra-white--hover">Booking Online</a>
							...
							<div id="pb-4-2">
								<div class="pbox-4-description white--color">
									<div class="pbox-4-caption">
										...
										<!-- Button -->	
										<a href="gift-cards.html" class="btn violet-red--btn tra-white--hover">Find Out More</a>
			...
			<section id="newsletter-1" class="newsletter-section division">
				<div class="container">
					<div class="newsletter-wrapper bg--honey-dew">
						...
						<div class="row justify-content-center">	
							<div class="col-lg-10 col-xl-8">
								<div class="section-title title-01 mb-50">	
									...
									<!-- Section ID -->	
						 			<span class="section-id">Connect with La Notte</span>	

									<!-- Title -->	
									<h2 class="h2-lg">Join Our Newsletter</h2>	
								...
								<form class="newsletter-form">
									...
									<div class="input-group">
										...
										<span class="input-group-btn">
											<button type="submit" class="btn violet-red--btn black--hover">Subscribe Now</button>
										</span>										
									</div>

									<!-- Small Text -->
									<p class="p-md">By signing and clicking Submit, you affirm you have read and agree to the 
										<a href="#" class="black--color">Privacy Policy</a> and <a href="#" class="black--color">Terms of Use</a>, 
					...
					<div class="row">
						...
						<div class="col-sm-6 col-lg-3">
							<div class="google-map mb-30">	
								<a href="https://www.google.com/maps/place/121+King+St,+Melbourne+VIC+3000,+Австралия/@-37.817251,144.9535863,17z/data=!3m1!4b1!4m5!3m4!1s0x6ad65d4dd5a05d97:0x3e64f855a564844d!8m2!3d-37.817251!4d144.955775" target="_blank">
...
<!-- Mirrored from dsathemes.com/html/la_notte_1.1/files/demo-9.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 Jun 2023 07:28:45 GMT -->
</html>
